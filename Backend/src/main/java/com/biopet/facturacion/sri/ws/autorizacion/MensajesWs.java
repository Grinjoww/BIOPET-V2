...
/** Envoltorio de mensajes con N elementos {@code mensaje}. */
@XmlAccessorType(XmlAccessType.FIELD)
public class MensajesWs {

    /**
     * QUALIFIED por la misma razon que en {@code AutorizacionesWs}: el WSDL lo
     * declara como {@code ref="tns:mensaje"}, una referencia a un elemento
     * global, y esos van siempre con el namespace del esquema.
     */
    @XmlElement(name = "mensaje", namespace = NamespaceAutorizacion.URI)
